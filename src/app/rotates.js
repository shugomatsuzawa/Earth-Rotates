...
const Rotates = () => {
  ...
  useEffect(() => {
    const id = setInterval(() => {
      ...
      setDateDisplay([<span className='text-xl font-bold'>{year}<ruby>年<rp>(</rp><rt>ねん</rt><rp>)</rp></ruby>{month}<ruby>月<rp>(</rp><rt>がつ</rt><rp>)</rp></ruby>{date}<ruby>日<rp>(</rp><rt>にち</rt><rp>)</rp></ruby>&nbsp;{day}<ruby>曜日<rp>(</rp><rt>ようび</rt><rp>)</rp></ruby></span>]);
      setTimeDisplay([<span className='text-xl font-bold'>{ampm}{hour}<ruby>時<rp>(</rp><rt>じ</rt><rp>)</rp></ruby>{min}<ruby>分<rp>(</rp><rt>ふん</rt><rp>)</rp></ruby>{sec}<ruby>秒<rp>(</rp><rt>びょう</rt><rp>)</rp></ruby></span>]);
  ...
  return (
    <>
      { clockError ? (
        ...
        <>
          <div className='tabular-nums text-center'><ruby>今日<rp>(</rp><rt>きょう</rt><rp>)</rp></ruby>は<br />{dateDisplay}<br />{timeDisplay} {tzDisplay}</div>
          <div className='tabular-nums mt-10 text-center'><ruby>地球<rp>(</rp><rt>ちきゅう</rt><rp>)</rp></ruby>は、だいたい<br /><span className='inline-block text-end font-bold'>{rotatesDisplay}</span><br />くらい<ruby>回<rp>(</rp><rt>まわ</rt><rp>)</rp></ruby>りました</div>
        </>
      )}
